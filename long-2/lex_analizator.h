...
public:
	enum states_1 { WORD, WORDINBRAK, BRAKETS, SEPARATOR, OPERATOR, INTCONST, FLCONST, COMMENT, LCOMMENT, UNKNOWN};
	enum statees {DECLARE, PROCESS,  TYPE, NAME, SEP, BRAKET, STRING, ICONST, FCONST, OP, INFO, READ, WRITE, PRINT, ROTATE, ROW, COLUMN, MAKE_CANONICAL };
	Lex_analizator() {}
